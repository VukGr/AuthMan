...
describe('Group operations', () => {
  describe('Creation', () => {
    test('succeeds with valid data', async () => {
      ...
      const groupsAtEnd = await helper.allGroups()
  ...
  describe('Read by id', () => {
    test('succeeds witha  valid id', async () => {
      const groupToView = (await helper.allGroups())[0]
      const res = await api
  ...
  describe('Update', () => {
    test('succeeds with status code 200 if id and data are valid', async () => {
      const targetGroup = (await helper.allGroups())[0]
  ...
  describe('Deletion', () => {
    test('succeeds with status code 204 if id is valid', async () => {
      const groupToDelete = (await helper.allGroups())[0]
